...
const AdminComplaintsDashboard = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-800 to-indigo-700 text-gray-800">
      {/* Navigation */}
      <nav className="bg-white bg-opacity-95 backdrop-blur-sm shadow-lg border-b border-white border-opacity-20 p-4 flex justify-between items-center sticky top-0 z-50">
        ...
        <div className="flex gap-8">
          <a href="dashboard.html" className="text-gray-800 font-medium text-base py-2 px-4 rounded-full transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-800 hover:to-indigo-700 hover:text-white hover:-translate-y-1">
            <i className="fas fa-home"></i> Dashboard
          </a>
          <a href="complaints.html" className="text-gray-800 font-medium text-base py-2 px-4 rounded-full transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-800 hover:to-indigo-700 hover:text-white hover:-translate-y-1">
            <i className="fas fa-exclamation-triangle"></i> Complaints
          </a>
          <a href="departments.html" className="text-gray-800 font-medium text-base py-2 px-4 rounded-full transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-800 hover:to-indigo-700 hover:text-white hover:-translate-y-1">
            <i className="fas fa-building"></i> Departments
          </a>
          <a href="profile.html" className="text-gray-800 font-medium text-base py-2 px-4 rounded-full transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-800 hover:to-indigo-700 hover:text-white hover:-translate-y-1">
