...
453331, 453441, 453551, 453661, 453771, 452020, 453001
    ...
    sector :       Optional[Annotated[Literal['Public Department','Water & Drainage / Sewerage Department','Health Establishment/Department','Electrical & Mechanical Department' , 'Revenue Department' , 'Garden/Parks Department','Planning & Information Tech Department','Traffic & transport Department','Housing & Environmental Department / Colony Cell' , 'Fire Department'] , Field(...,description="choose Your department")]]
    password : str 
    re_password :str
    ...
    def check_password_match(self)->'Admin_update':
